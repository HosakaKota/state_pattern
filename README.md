...
# ビルド状態
[![MSBuild](https://github.com/HosakaKota/state_pattern/actions/workflows/msbuild.yml/badge.svg)](https://github.com/HoasakaKota/state_pattern/actions/workflows/msbuild.yml)
